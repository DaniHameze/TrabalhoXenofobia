  ...
  document.getElementById('guess-button').addEventListener('click', function() {
    ...
    if (guess.length !== 1 || !guess.match(/[a-z]/)) {
      ...
      uploadPic() //Parte que tava dando erro e custou 4hrs preciosas do dia da Dani 
    }
...
/*guessedWord - letras adivinhadas corretamente */
/*guessedLetters - letra chutada pelo jogador */
/*attempts - número de tentativas restantes */
